...
<header>
    <h1>PetPal</h1>
    <nav>
        <a href="file:/C:/PetPal/jsp/login.jsp">Home</a>
...
<main>
    ...
    <p>Discover your perfect companion from shelters across the country.</p>
    <div class="search-bar">
        <input type="text" placeholder="Search by breed, city, or ZIP" />
        <select>
    ...
    <div class="card-container">
        <div class="card">
            <img src="images/dog1.jpg" alt="Max">
        ...
        <div class="card">
            <img src="images/cat1.jpeg" alt="Luna">
            <div class="card-content">
                <h4>Luna</h4>
        ...
        <div class="card">
            <img src="images/dog2.jpg" alt="Buddy">
            <div class="card-content">
                <h4>Buddy</h4>
